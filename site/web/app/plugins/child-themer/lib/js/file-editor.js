		...
		window.setTimeout(function() {
			...
			if(response.substring(0, 5) != 'Error') {
				if(theme_type == 'child') {
					...
					$('#child-themer-file-editor-file-control-settings-icon').fadeIn().html('<span id="child-themer-file-editor-reload-page"><a href="'+child_themer_admin_url+'admin.php?page=child-themer-file-editor">Reload Page</a> to see changes...</span><span class="dashicons dashicons-admin-generic"></span>');
				}
			}
		}, 2222);
	}
